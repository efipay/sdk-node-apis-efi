...
import EfiPay, { type PixConfigWebhookRecurrenceAutomaticBody, type RequestHeaders, type SdkOptions } from "sdk-node-apis-efi";
import options from "../../../credentials/options.js";

const body = {
    "webhookUrl": "https://seudominio.com.br/webhook/"
} satisfies PixConfigWebhookRecurrenceAutomaticBody;
