...
import EfiPay, { type PixUpdateDueChargeBatchBody, type PixUpdateDueChargeBatchParams, type SdkOptions } from "sdk-node-apis-efi";
import options from "../../../credentials/options.js";

const params = {
    "id": 1
} satisfies PixUpdateDueChargeBatchParams;
...
} satisfies PixUpdateDueChargeBatchBody;
