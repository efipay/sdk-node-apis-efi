...
export type ApiKey = keyof typeof endpoints.APIS;
export type ApiConfig = (typeof endpoints.APIS)[ApiKey];
export type EndpointConfig = ApiConfig['ENDPOINTS'][keyof ApiConfig['ENDPOINTS']];
